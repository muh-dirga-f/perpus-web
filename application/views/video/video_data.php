...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <?php echo anchor('video/create', '<i class="fas fa-plus"></i> Tambah Data', array('class' => 'btn btn-primary btn-sm')); ?>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered" id="dataTables-example" width="100%" cellspacing="0">
                ...
                ?>
                    <tr>
                        <td><?php echo $no;?></td>
                        <!-- jika ada video di dalam database maka tampilkan -->
                        <td><?php if($row->image != "") { ?>
                            <img src="<?php echo base_url('assets/img/video/'.$row->image);?>" width="100px" height="100px">
                        <?php }else{ ?>
                            <img src="<?php echo base_url('assets/img/video/book-default.jpg');?>" width="100px" height="100px">
                        <?php } ?> 
                        </td>
                        <td><?php echo $row->judul;?></td>
                        <td><?php echo $row->kode_video;?></td>
                        <td><?php echo $row->nama_kategori_video;?></td>
                        <td><?php echo $row->pembuat;?></td>
                        <td class="text-center">
                            <a href="<?php echo base_url('video/edit/'.$row->kode_video) ?>"><input type="submit" class="btn btn-success btn-sm" name="edit" value="Edit"></a>
                            <a href="#" name="<?php echo $row->judul;?>" class="hapus btn btn-danger btn-sm" kode="<?php echo $row->kode_video;?>">Hapus</a>
                        </td>
                    </tr>
                <?php $no++; } ?>    
                </tbody>
        ...
        $("#konfirmasi").click(function(){
            ...
            $.ajax({
                ...
                success:function(html){
                    location.href="<?php echo site_url('video/index/delete-success');?>";
                }
            });
        });
    });
