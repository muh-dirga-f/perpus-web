...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <?php echo anchor('kategori_buku/create', '<i class="fas fa-plus"></i> Tambah Data', array('class' => 'btn btn-primary btn-sm')); ?>
    </div>
    <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="<?php echo base_url('kategori_buku/edit/'.$row->id_kategori_buku) ?>"><input
                                    type="submit" class="btn btn-success btn-sm" name="edit" value="Edit"></a>
                            <a href="#" name="<?php echo $row->nama_kategori_buku;?>"
                                class="hapus btn btn-danger btn-sm"
                                kode="<?php echo $row->id_kategori_buku;?>">Hapus</a>
                        </td>
                    </tr>
                    <?php $no++; } ?>
                </tbody>
...
<script>
    $(document).ready(function () {
        ...
        $("#konfirmasi").click(function () {
            ...
            $.ajax({
                url: "<?php echo site_url('kategori_buku/delete');?>",
                type: "POST",
                data: "kode_buku=" + kode_buku,
                cache: false,
                success: function (html) {
                    location.href =
                        "<?php echo site_url('kategori_buku/index/delete-success');?>";
                }
            });
        });
    });
